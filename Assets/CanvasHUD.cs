...
public class CanvasHUD : MonoBehaviour
{
    ...
    public Button buttonServer, buttonClient, buttonStop , buttonClientReady, buttonStartGame;
    ...
    private void Start()
    {
        ...
        buttonClientReady.onClick.AddListener(ButtonClientReady);
        buttonStartGame.onClick.AddListener(ButtonStartGame);
    ...
    {
        NetworkRoomManager.singleton.Start();
        SetupCanvas();
    }
