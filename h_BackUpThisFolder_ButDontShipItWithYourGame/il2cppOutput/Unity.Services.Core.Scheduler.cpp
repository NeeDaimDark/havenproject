...
IL_0031:
	{
		// lock (m_Lock)
		RuntimeObject* L_6 = __this->___m_Lock_1;
		V_2 = L_6;
		V_3 = (bool)0;
	}
	{
		...
		{// begin try (depth: 1)
			{
				...
				NullCheck(L_13);
				L_13->___InvocationTime_1 = L_17;
				ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_18 = L_13;
				int64_t L_19 = __this->___m_NextId_5;
				V_6 = L_19;
				int64_t L_20 = V_6;
				__this->___m_NextId_5 = ((int64_t)il2cpp_codegen_add(L_20, ((int64_t)1)));
				int64_t L_21 = V_6;
				NullCheck(L_18);
				L_18->___ActionId_2 = L_21;
				V_4 = L_18;
				// if (m_NextId < k_MinimumIdValue)
				int64_t L_22 = __this->___m_NextId_5;
...
IL_00a2_1:
			{
				...
				MinimumBinaryHeap_1_tB7A85B4D870F0107AF6031545D6054927A1CB7AD* L_24 = __this->___m_ScheduledActions_2;
				...
				Dictionary_2_t2306F810ADE46E708DBCF5BFFD57ED345A61D8CA* L_26 = __this->___m_IdScheduledInvocationMap_3;
				...
				NullCheck(L_30);
				int64_t L_31 = L_30->___ActionId_2;
				V_8 = L_31;
				goto IL_00db;
			}
		}// end try (depth: 1)
...
IL_002c_1:
			{
				...
				MinimumBinaryHeap_1_tB7A85B4D870F0107AF6031545D6054927A1CB7AD* L_8 = __this->___m_ScheduledActions_2;
				...
				Dictionary_2_t2306F810ADE46E708DBCF5BFFD57ED345A61D8CA* L_10 = __this->___m_IdScheduledInvocationMap_3;
				ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_11 = V_2;
				NullCheck(L_11);
				int64_t L_12 = L_11->___ActionId_2;
				NullCheck(L_10);
				bool L_13;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ActionScheduler_ExecuteExpiredActions_mB683F55950DD543D90A479DF7E68539969F2B48C (ActionScheduler_t25AE26866357EBC70F6698FCD3E0B6DBE7473154* __this, const RuntimeMethod* method) 
{
	...
	Enumerator_tAE300C7056BDE583F62C47321CE68904319DE228 V_8;
	memset((&V_8), 0, sizeof(V_8));
	ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* V_9 = NULL;
...
IL_0051_1:
			...
			{
				il2cpp_codegen_initobj((&V_7), sizeof(Nullable_1_tEADC262F7F8B8BC4CC0A003DBDD3CA7C1B63F9AC));
				Nullable_1_tEADC262F7F8B8BC4CC0A003DBDD3CA7C1B63F9AC L_20 = V_7;
				G_B7_0 = L_20;
				goto IL_0084_1;
			}
...
IL_0084_1:
			{
				...
				V_6 = L_24;
				bool L_25;
				L_25 = Nullable_1_get_HasValue_m092C73DCE052BFB5C60A39EF9F4E3401AA95221C_inline((&V_5), Nullable_1_get_HasValue_m092C73DCE052BFB5C60A39EF9F4E3401AA95221C_RuntimeMethod_var);
				if (L_25)
				{
					goto IL_009f_1;
				}
...
IL_009f_1:
			{
				...
				L_26 = Nullable_1_GetValueOrDefault_mBE26FDBA8873F7AE883FF290864E1D2665EAC52F_inline((&V_5), Nullable_1_GetValueOrDefault_mBE26FDBA8873F7AE883FF290864E1D2665EAC52F_RuntimeMethod_var);
...
IL_00c7:
	{
		...
		List_1_tFD4080EF47ACD067F2E4AB57C9E2E8E64CA953E3* L_30 = V_0;
		NullCheck(L_30);
...
FINALLY_0107:
			{// begin finally (depth: 1)
				Enumerator_Dispose_mAC237D510E358726C014DD3F610942E989613559((&V_8), Enumerator_Dispose_mAC237D510E358726C014DD3F610942E989613559_RuntimeMethod_var);
				return;
			}// end finally (depth: 1)
		});
		try
...
IL_00d2_1:
			{
				...
				L_32 = Enumerator_get_Current_m76478B2825D5D7493DFBD3E478233114BE128B35_inline((&V_8), Enumerator_get_Current_m76478B2825D5D7493DFBD3E478233114BE128B35_RuntimeMethod_var);
				V_9 = L_32;
			}
			try
			{// begin try (depth: 2)
				// scheduledInv.Action();
				ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_33 = V_9;
				NullCheck(L_33);
				Action_tD00B0A84D7945E50C2DFFC28EFEE6ED44ED2AD07* L_34 = L_33->___Action_0;
				NullCheck(L_34);
...
CATCH_00ed_1:
			{// begin catch(System.Exception)
				...
				CoreLogger_LogException_m7129C6F678E086232211CBC0347F2300D0A42F3C(L_35, NULL);
...
IL_00fc_1:
			{
				// foreach (var scheduledInv in scheduledInvocationList)
				bool L_36;
				L_36 = Enumerator_MoveNext_m46C4F2A2917BB3C219137A08B6E29579FCBF6CA5((&V_8), Enumerator_MoveNext_m46C4F2A2917BB3C219137A08B6E29579FCBF6CA5_RuntimeMethod_var);
				if (L_36)
				{
					goto IL_00d2_1;
				}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ActionScheduler_JoinPlayerLoopSystem_mB998001E51285B4DF2406DE197A3A5377BD62892 (ActionScheduler_t25AE26866357EBC70F6698FCD3E0B6DBE7473154* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		PlayerLoopSystem_t8AED6BF1C8A309CAA6FF71AC91DD33BDDFF7CF1F L_9 = __this->___SchedulerLoopSystem_4;
		NullCheck(L_8);
...
IL_000e:
	{
		...
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_3 = ___y1;
...
IL_001b:
	{
		...
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_5 = ___x0;
...
IL_002a:
	{
		...
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_7 = ___x0;
		NullCheck(L_7);
		DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D* L_8 = (&L_7->___InvocationTime_1);
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_9 = ___y1;
		NullCheck(L_9);
		DateTime_t66193957C73913903DDAD89FEDC46139BCA5802D L_10 = L_9->___InvocationTime_1;
		int32_t L_11;
	...
	}
	{
		...
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_14 = ___x0;
		NullCheck(L_14);
		int64_t* L_15 = (&L_14->___ActionId_2);
		ScheduledInvocation_t049B2F607AC8AAA60877C47F1F9D5F8EBDBA0B93* L_16 = ___y1;
		NullCheck(L_16);
		int64_t L_17 = L_16->___ActionId_2;
		int32_t L_18;
