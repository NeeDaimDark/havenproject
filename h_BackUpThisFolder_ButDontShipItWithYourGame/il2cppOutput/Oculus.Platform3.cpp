...
IL_0040_2:
					{
						...
						NullCheck(L_12);
						VirtualActionInvoker1< int32_t >::Invoke(19 /* System.Void System.IO.BinaryWriter::Write(System.Int32) */, L_12, L_13);
						...
						NullCheck(L_14);
						VirtualActionInvoker1< CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* >::Invoke(15 /* System.Void System.IO.BinaryWriter::Write(System.Char[]) */, L_14, L_16);
						// writer.Write('\0');
						BinaryWriter_tFB94D67EDFA3F6A34744A163BDABE287FDF2ED1E* L_17 = V_1;
						NullCheck(L_17);
						VirtualActionInvoker1< Il2CppChar >::Invoke(14 /* System.Void System.IO.BinaryWriter::Write(System.Char) */, L_17, 0);
						goto IL_0075_1;
					}
				}// end try (depth: 2)
...
IL_004d_1:
				...
				{// begin try (depth: 2)
					...
					NullCheck(L_13);
					String_t* L_16;
					L_16 = VirtualFuncInvoker1< String_t*, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* >::Invoke(36 /* System.String System.Text.Encoding::GetString(System.Byte[]) */, L_13, L_15);
					NullCheck(L_12);
