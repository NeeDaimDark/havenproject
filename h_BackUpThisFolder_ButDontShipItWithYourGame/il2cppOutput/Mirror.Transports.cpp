...
struct KcpTransport_t7F1A671A92E026EE52302B0EB60FA7B30A25D074  : public Transport_t8E1D3887BA35250F79E4200BB8008A5C2D4E7E07
{
	...
	KcpConfig_t0C03722728EF98EB68D698A5DE03B2EEA9921FD3* ___config_29;
	// kcp2k.KcpServer kcp2k.KcpTransport::server
	KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* ___server_30;
	// kcp2k.KcpClient kcp2k.KcpTransport::client
	KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* ___client_31;
...
IL_002b:
	{
		...
		float L_8 = __this->___reliableLatency_18;
		float L_9 = V_0;
		V_3 = ((float)il2cpp_codegen_add(((float)(L_8/(1000.0f))), L_9));
		goto IL_0055;
	}
...
IL_003c:
	{
		...
		float L_10 = __this->___unreliableLatency_20;
		float L_11 = V_0;
		V_3 = ((float)il2cpp_codegen_add(((float)(L_10/(1000.0f))), L_11));
		goto IL_0055;
	}
...
IL_006c:
	{
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_15 = ___reliableQueue4;
...
IL_007a:
	{
		...
		Random_t79716069EDE67D1D7734F60AE402D0CA3FB6B4C8* L_17 = __this->___random_26;
		NullCheck(L_17);
		double L_18;
		L_18 = VirtualFuncInvoker0< double >::Invoke(8 /* System.Double System.Random::NextDouble() */, L_17);
		float L_19 = __this->___unreliableLoss_19;
		V_3 = (bool)((((double)L_18) < ((double)((double)((float)(L_19/(100.0f))))))? 1 : 0);
		// if (!drop)
		bool L_20 = V_3;
	...
	}
	{
		...
		Random_t79716069EDE67D1D7734F60AE402D0CA3FB6B4C8* L_22 = __this->___random_26;
		NullCheck(L_22);
		double L_23;
		L_23 = VirtualFuncInvoker0< double >::Invoke(8 /* System.Double System.Random::NextDouble() */, L_22);
		float L_24 = __this->___unreliableScramble_21;
		V_7 = (bool)((((double)L_23) < ((double)((double)((float)(L_24/(100.0f))))))? 1 : 0);
		// int last = unreliableQueue.Count;
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_25 = ___unreliableQueue5;
		NullCheck(L_25);
		int32_t L_26;
...
IL_00cd:
	{
		Random_t79716069EDE67D1D7734F60AE402D0CA3FB6B4C8* L_29 = __this->___random_26;
		int32_t L_30 = V_8;
		NullCheck(L_29);
		int32_t L_31;
...
IL_00dd:
	{
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_32 = ___unreliableQueue5;
		int32_t L_33 = V_9;
...
IL_0005:
	...
	}
	{
		...
		Transport_t8E1D3887BA35250F79E4200BB8008A5C2D4E7E07* L_7 = __this->___wrap_15;
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_11 = __this->___reliableClientToServer_22;
		int32_t L_12 = V_0;
		NullCheck(L_11);
...
IL_0057:
	{
		// for (int i = 0; i < reliableClientToServer.Count; ++i)
		int32_t L_15 = V_0;
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_16 = __this->___reliableClientToServer_22;
		NullCheck(L_16);
		int32_t L_17;
...
IL_006e:
	{
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_19 = __this->___unreliableClientToServer_24;
		int32_t L_20 = V_4;
		NullCheck(L_19);
	...
	{
		// wrap.ClientSend(new ArraySegment<byte>(message.bytes), Channels.Reliable);
		Transport_t8E1D3887BA35250F79E4200BB8008A5C2D4E7E07* L_26 = __this->___wrap_15;
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_30 = __this->___unreliableClientToServer_24;
		int32_t L_31 = V_4;
		NullCheck(L_30);
...
IL_00cb:
	{
		// for (int i = 0; i < unreliableClientToServer.Count; ++i)
		int32_t L_34 = V_4;
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_35 = __this->___unreliableClientToServer_24;
		NullCheck(L_35);
		int32_t L_36;
...
IL_0005:
	...
	}
	{
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_13 = __this->___reliableServerToClient_23;
		int32_t L_14 = V_0;
		NullCheck(L_13);
...
IL_005d:
	{
		// for (int i = 0; i < reliableServerToClient.Count; ++i)
		int32_t L_17 = V_0;
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_18 = __this->___reliableServerToClient_23;
		NullCheck(L_18);
		int32_t L_19;
...
IL_0074:
	{
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_21 = __this->___unreliableServerToClient_25;
		int32_t L_22 = V_4;
		NullCheck(L_21);
	...
	{
		// wrap.ServerSend(message.connectionId, new ArraySegment<byte>(message.bytes), Channels.Reliable);
		Transport_t8E1D3887BA35250F79E4200BB8008A5C2D4E7E07* L_28 = __this->___wrap_15;
		...
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_34 = __this->___unreliableServerToClient_25;
		int32_t L_35 = V_4;
		NullCheck(L_34);
...
IL_00d8:
	{
		// for (int i = 0; i < unreliableServerToClient.Count; ++i)
		int32_t L_38 = V_4;
		List_1_tCE352F5FA705304380D0469B6045D5FA18E8D4B7* L_39 = __this->___unreliableServerToClient_25;
		NullCheck(L_39);
		int32_t L_40;
	...
	}
	{
		...
		Transport_t8E1D3887BA35250F79E4200BB8008A5C2D4E7E07* L_42 = __this->___wrap_15;
		NullCheck(L_42);
...
IL_0047:
	{
		uint16_t L_11 = __this->___port_16;
		G_B5_0 = ((int32_t)(L_11));
	}
...
IL_004d:
	{
		...
		Client_t20C4A90FC449D8BE16EC6ED1368A5AB3AC647042* L_12 = __this->___client_28;
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_13 = ___uri0;
		NullCheck(L_13);
		String_t* L_14;
...
IL_001c:
	{
		int32_t L_4 = __this->___clientMaxReceivesPerTick_25;
		Func_1_t2BE7F58348C9CC544A8973B3A9E55541DE43C457* L_5 = __this->___enabledCheck_30;
		NullCheck(G_B4_0);
		int32_t L_6;
...
IL_001c:
	{
		int32_t L_4 = __this->___serverMaxReceivesPerTick_21;
		Func_1_t2BE7F58348C9CC544A8973B3A9E55541DE43C457* L_5 = __this->___enabledCheck_30;
		NullCheck(G_B4_0);
		int32_t L_6;
...
IL_0027:
	...
	}
	{
		...
		uint16_t L_6 = __this->___port_16;
		uint16_t L_7 = L_6;
...
IL_0044:
	...
	{
		Client_t20C4A90FC449D8BE16EC6ED1368A5AB3AC647042* L_13 = __this->___client_28;
		NullCheck(L_13);
		bool L_14;
...
IL_006a:
	...
	}
	{
		...
		uint16_t L_16 = __this->___port_16;
		uint16_t L_17 = L_16;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void KcpTransport_Awake_m068F5109644FD81DC48614888C6C6C8CA7166B31 (KcpTransport_t7F1A671A92E026EE52302B0EB60FA7B30A25D074* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (debugLog)
		bool L_0 = __this->___debugLog_32;
		V_0 = L_0;
		bool L_1 = V_0;
		if (!L_1)
		{
...
IL_0042:
	{
		...
		bool L_10 = __this->___DualMode_17;
		bool L_11 = __this->___MaximizeSocketBuffers_26;
		bool L_12 = __this->___NoDelay_18;
		uint32_t L_13 = __this->___Interval_19;
		int32_t L_14 = __this->___FastResend_21;
		bool L_15 = __this->___CongestionWindow_22;
		uint32_t L_16 = __this->___SendWindowSize_23;
		uint32_t L_17 = __this->___ReceiveWindowSize_24;
		int32_t L_18 = __this->___Timeout_20;
		uint32_t L_19 = __this->___MaxRetransmit_25;
		...
		__this->___config_29 = L_20;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___config_29), (void*)L_20);
		...
		__this->___client_31 = L_25;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___client_31), (void*)L_25);
		...
		KcpConfig_t0C03722728EF98EB68D698A5DE03B2EEA9921FD3* L_30 = __this->___config_29;
		...
		__this->___server_30 = L_31;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___server_30), (void*)L_31);
		// if (statisticsLog)
		bool L_32 = __this->___statisticsLog_34;
		V_1 = L_32;
		bool L_33 = V_1;
		if (!L_33)
		{
...
{
	{
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_0 = __this->___client_31;
		NullCheck(L_0);
...
{
	{
		...
		String_t* L_1 = ___address0;
		uint16_t L_2 = __this->___Port_16;
		KcpConfig_t0C03722728EF98EB68D698A5DE03B2EEA9921FD3* L_3 = __this->___config_29;
		NullCheck(L_0);
...
IL_0046:
	{
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_12 = __this->___client_31;
		Uri_t1500A52B5F71A04F5D05C0852D0F2A0941842A0E* L_13 = ___uri0;
		NullCheck(L_13);
		String_t* L_14;
		L_14 = Uri_get_Host_m2C0E258C7DFF7A340049BE9BC08FF45E90988D8C(L_13, NULL);
		int32_t L_15 = V_0;
		KcpConfig_t0C03722728EF98EB68D698A5DE03B2EEA9921FD3* L_16 = __this->___config_29;
		NullCheck(L_12);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void KcpTransport_ClientEarlyUpdate_m20DBC38DD7829C8D527AEA494A776ACEC3DFA651 (KcpTransport_t7F1A671A92E026EE52302B0EB60FA7B30A25D074* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (enabled) client.TickIncoming();
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_2 = __this->___client_31;
		NullCheck(L_2);
...
{
	{
		...
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_0 = __this->___server_30;
		NullCheck(L_0);
		bool L_1;
...
{
	{
		...
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_0 = __this->___server_30;
		uint16_t L_1 = __this->___Port_16;
		NullCheck(L_0);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void KcpTransport_ServerEarlyUpdate_m3AAD2825DA56007F2F20F8E89F71BA22CA91950B (KcpTransport_t7F1A671A92E026EE52302B0EB60FA7B30A25D074* __this, const RuntimeMethod* method) 
{
	...
	{
		// if (enabled) server.TickIncoming();
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_2 = __this->___server_30;
		NullCheck(L_2);
...
IL_0013:
	{
		...
		uint32_t L_3 = __this->___ReceiveWindowSize_24;
		int32_t L_4;
...
IL_0017:
	{
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_3 = __this->___server_30;
		NullCheck(L_3);
...
IL_0046:
	{
		...
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_12 = __this->___server_30;
		NullCheck(L_12);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void KcpTransport_OnGUI_m2570F849C121CFD3DED9284D72D23D4882994593 (KcpTransport_t7F1A671A92E026EE52302B0EB60FA7B30A25D074* __this, const RuntimeMethod* method) 
{
	...
	bool V_2 = false;
	{
		...
		bool L_0 = __this->___statisticsGUI_33;
		V_0 = (bool)((((int32_t)L_0) == ((int32_t)0))? 1 : 0);
		bool L_1 = V_0;
		if (!L_1)
		{
...
IL_0013:
	...
	}
	{
		...
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_8 = __this->___server_30;
		NullCheck(L_8);
...
IL_0160:
	...
	}
	{
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_48 = __this->___client_31;
		NullCheck(L_48);
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_54 = __this->___client_31;
		NullCheck(L_54);
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_60 = __this->___client_31;
		NullCheck(L_60);
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_67 = __this->___client_31;
		NullCheck(L_67);
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_74 = __this->___client_31;
		NullCheck(L_74);
		...
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_81 = __this->___client_31;
		NullCheck(L_81);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void KcpTransport_OnLogStatistics_m5D49236A5931F55BE3BF85DFF7B6C61C848A7C70 (KcpTransport_t7F1A671A92E026EE52302B0EB60FA7B30A25D074* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		String_t* L_5 = V_1;
		KcpServer_tE26814B163D77A83F9DE98DE794A92C1C34475F6* L_6 = __this->___server_30;
		NullCheck(L_6);
...
IL_0102:
	...
	}
	{
		...
		String_t* L_51 = V_4;
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_52 = __this->___client_31;
		NullCheck(L_52);
		...
		String_t* L_57 = V_4;
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_58 = __this->___client_31;
		NullCheck(L_58);
		...
		String_t* L_63 = V_4;
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_64 = __this->___client_31;
		NullCheck(L_64);
		...
		String_t* L_71 = V_4;
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_72 = __this->___client_31;
		NullCheck(L_72);
		...
		String_t* L_79 = V_4;
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_80 = __this->___client_31;
		NullCheck(L_80);
		...
		String_t* L_87 = V_4;
		KcpClient_t26F877ED9501BB62952A8FC7D5C294EF4431B5A5* L_88 = __this->___client_31;
		NullCheck(L_88);
